    ...
    def save_pdf(self, uploaded_file):
        try:
            ...
            if not filename.lower().endswith('.pdf'):
                raise DocumentPortalException("Invalid file type. Please upload a PDF file.")
...
if __name__ == "__main__":
    ...
    pdf_path = r"/Users/heydipanjan/Desktop/LLMOps/document_portal/data/document_analysis/NIPS-2017-attention-is-all-you-need-Paper.pdf"
